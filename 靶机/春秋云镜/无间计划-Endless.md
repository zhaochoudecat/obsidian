...
![](file-20260708144516994.png)
# flag01
## 登录 39.101.140.137
可能是SQL注入
![697](file-20260708144516996.png)

## 登录39.101.138.52
有PbootCMS，PbootCMS 是一款**永久开源免费、可商用**的轻量级 PHP 企业建站系统，由于是PHP搭建的，尝试寻找漏洞
![](file-20260708144517006.png)
...
### 六、配置proxifier
#### 1.配置proxies
![](file-20260708144517039.png)

#### 2.配置rules
![](file-20260708144517041.png)
...
![](file-20260708144517044.png)

#### flag02
![](file-20260708144517046.png)
...
```
![](file-20260708144517061.png)

#### 发现名单
![](file-20260708144517098.png)
